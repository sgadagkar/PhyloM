...
uses
  modpimd_b, modCalcErrs, modTreeGraph, modTreeView; //, modAbout;
...
//    end;
    ...
    begin
      ...
      if frmPIMD_B.trvwTreeGraph.Items.Count > 0 then
      begin
        for inx := 0 to frmPIMD_B.trvwTreeGraph.Items.Count - 1 do
          if frmPIMD_B.trvwTreeGraph.Items[inx].Data <> nil then
            Dispose(PTreeViewMember(frmPIMD_B.trvwTreeGraph.Items[inx].Data));
        frmPIMD_B.trvwTreeGraph.Items.Clear;
      end;
...
begin
  try
    ...
    begin
      ...
      with frmPIMD_B.strgrdResult do
      begin
        Cells[0, 1] := IntToStr(E.HelpContext);
        Cells[1, 0] := 'Error';
        Cells[1, 1] := E.Message;
  ...
  frmPIMD_B.strgrdResult.AutoSizeColumns;
  with TestTableForSpeciesData, frmPIMD_B.strgrdResult do
